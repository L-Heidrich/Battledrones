...
public class ProfileData
{
    ...
    public ProfileData(string n_name, int n_level, int n_exp, int c)
    {
...
public class MainMenu : MonoBehaviourPunCallbacks
{
    ...
    public void Connect()
        ...
        public void Create()
        {
            ...
            options.MaxPlayers = (byte) playerSlider.value;
    ...
    public void OpenCreate()
    {
        ...
        maxPlayerText.text = Mathf.RoundToInt(playerSlider.value).ToString();
